...
public class TTC {
//vibrateur and tudbut
    // FML stuff and version
    public static final String MODID = "atc";
    public static final String NAME = "ATClient";
    public static final String VERSION = "v0.0.1";
    // TODO: PLEASE change this when skidding or rebranding.
    //  It is used for analytics and doesn't affect gameplay
    public static final String BRAND = "vibrateur/ATClient:master";
    public static final String REPO = "vibrateur/ATClient";
